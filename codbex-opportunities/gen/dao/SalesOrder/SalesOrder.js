...
const EntityUtils = require("codbex-opportunities/gen/dao/utils/EntityUtils");
...
function triggerEvent(operation, data) {
	producer.queue("codbex-opportunities/SalesOrder/SalesOrder/" + operation).send(JSON.stringify(data));
}