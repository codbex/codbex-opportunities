...
const dao = require("codbex-opportunities/gen/dao/Settings/OpportunityStatus");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-opportunities/gen/api/OpportunityStatus.js/" + entity.Id);
