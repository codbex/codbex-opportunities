...
const dao = require("codbex-opportunities/gen/dao/Settings/LeadStatus");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-opportunities/gen/api/LeadStatus.js/" + entity.Id);
