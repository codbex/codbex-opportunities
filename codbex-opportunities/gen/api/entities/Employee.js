...
const dao = require("codbex-opportunities/gen/dao/entities/Employee");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-opportunities/gen/api/Employee.js/" + entity.Id);
