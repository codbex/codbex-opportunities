...
const dao = require("codbex-opportunities/gen/dao/entities/Industry");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-opportunities/gen/api/Industry.js/" + entity.Id);
