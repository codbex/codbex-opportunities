...
const dao = require("codbex-opportunities/gen/dao/entities/Currency");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-opportunities/gen/api/Currency.js/" + entity.Code);
