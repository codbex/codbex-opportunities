...
const dao = require("codbex-opportunities/gen/dao/entities/LeadNote");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-opportunities/gen/api/LeadNote.js/" + entity.Id);
