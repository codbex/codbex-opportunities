...
const dao = require("codbex-opportunities/gen/dao/quotation/Quotation");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-opportunities/gen/api/Quotation.js/" + entity.Id);
