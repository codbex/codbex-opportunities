...
const dao = require("codbex-opportunities/gen/dao/Quotation/QuotationItem");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-opportunities/gen/api/QuotationItem.js/" + entity.Id);
