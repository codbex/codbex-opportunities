...
class OpportunityNoteService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-opportunities/gen/api/Opportunity/OpportunityNoteService.ts/" + entity.Id);
    ...
    private validateEntity(entity: any): void {
        if (entity.Note?.length > 10000) {
            throw new ValidationError(`The 'Note' exceeds the maximum length of [10000] characters`);
        }
