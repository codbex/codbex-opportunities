...
const dao = require("codbex-opportunities/gen/dao/Opportunity/OpportunityNote");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-opportunities/gen/api/OpportunityNote.js/" + entity.Id);
