angular.module('page', ["ideUI", "ideView", "entityApi"])
    .config(["messageHubProvider", function (messageHubProvider) {
        messageHubProvider.eventIdPrefix = 'codbex-opportunities.Reports.LeadEngagement';
    }])
    .config(["entityApiProvider", function (entityApiProvider) {
        entityApiProvider.baseUrl = "/services/ts/codbex-opportunities/gen/lead-engagement/api/LeadEngagement/LeadEngagementService.ts";
    }])
    .controller('PageController', ['$scope', 'messageHub', 'entityApi', 'ViewParameters', function ($scope, messageHub, entityApi, ViewParameters) {
        ...
        window.onafterprint = () => {
            messageHub.closeDialogWindow("codbex-opportunities-Reports-LeadEngagement-print");
        }
