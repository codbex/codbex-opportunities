...
export interface ActionStatusEntityEvent {
...
export interface ActionStatusUpdateEntityEvent extends ActionStatusEntityEvent {
...
export class ActionStatusRepository {
    ...
    constructor(dataSource = "DefaultDB") {
        this.dao = daoApi.create(ActionStatusRepository.DEFINITION, undefined, dataSource);
    }
    ...
    public findById(id: number, options: ActionStatusEntityOptions = {}): ActionStatusEntity | undefined {
