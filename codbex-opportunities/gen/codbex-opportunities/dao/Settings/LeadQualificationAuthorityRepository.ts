...
export interface LeadQualificationAuthorityEntityEvent {
...
export interface LeadQualificationAuthorityUpdateEntityEvent extends LeadQualificationAuthorityEntityEvent {
...
export class LeadQualificationAuthorityRepository {
    ...
    constructor(dataSource = "DefaultDB") {
        this.dao = daoApi.create(LeadQualificationAuthorityRepository.DEFINITION, undefined, dataSource);
    }
    ...
    public findById(id: number, options: LeadQualificationAuthorityEntityOptions = {}): LeadQualificationAuthorityEntity | undefined {
