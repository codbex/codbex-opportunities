...
export interface LeadQualificationNeedEntityEvent {
...
export interface LeadQualificationNeedUpdateEntityEvent extends LeadQualificationNeedEntityEvent {
...
export class LeadQualificationNeedRepository {
    ...
    constructor(dataSource = "DefaultDB") {
        this.dao = daoApi.create(LeadQualificationNeedRepository.DEFINITION, undefined, dataSource);
    }
    ...
    public findById(id: number, options: LeadQualificationNeedEntityOptions = {}): LeadQualificationNeedEntity | undefined {
