...
class LeadQualificationService {
    ...
    private checkPermissions(operationType: string) {
        if (operationType === "read" && !(user.isInRole("codbex-opportunities.Lead.LeadQualificationReadOnly") || user.isInRole("codbex-opportunities.Lead.LeadQualificationFullAccess"))) {
            throw new ForbiddenError();
        }
        if (operationType === "write" && !user.isInRole("codbex-opportunities.Lead.LeadQualificationFullAccess")) {
            throw new ForbiddenError();
        }
    }
