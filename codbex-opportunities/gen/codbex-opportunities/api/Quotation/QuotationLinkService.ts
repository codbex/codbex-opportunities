...
class QuotationLinkService {
    ...
    private checkPermissions(operationType: string) {
        if (operationType === "read" && !(user.isInRole("codbex-opportunities.Quotation.QuotationLinkReadOnly") || user.isInRole("codbex-opportunities.Quotation.QuotationLinkFullAccess"))) {
            throw new ForbiddenError();
        }
        if (operationType === "write" && !user.isInRole("codbex-opportunities.Quotation.QuotationLinkFullAccess")) {
            throw new ForbiddenError();
        }
    }
