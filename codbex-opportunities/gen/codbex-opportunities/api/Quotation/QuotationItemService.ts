...
class QuotationItemService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-opportunities/gen/codbex-opportunities/api/Quotation/QuotationItemService.ts/" + entity.Id);
    ...
    private checkPermissions(operationType: string) {
        if (operationType === "read" && !(user.isInRole("codbex-opportunities.Quotation.QuotationItemReadOnly") || user.isInRole("codbex-opportunities.Quotation.QuotationItemFullAccess"))) {
            throw new ForbiddenError();
        }
        if (operationType === "write" && !user.isInRole("codbex-opportunities.Quotation.QuotationItemFullAccess")) {
            throw new ForbiddenError();
        }
    }
