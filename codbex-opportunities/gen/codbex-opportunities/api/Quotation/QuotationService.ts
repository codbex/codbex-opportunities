...
const validationModules = await Extensions.loadExtensionModules("codbex-opportunities-Quotation-Quotation", ["validate"]);
...
class QuotationService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-opportunities/gen/codbex-opportunities/api/Quotation/QuotationService.ts/" + entity.Id);
    ...
    private checkPermissions(operationType: string) {
        if (operationType === "read" && !(user.isInRole("codbex-opportunities.Quotation.QuotationReadOnly") || user.isInRole("codbex-opportunities.Quotation.QuotationFullAccess"))) {
            throw new ForbiddenError();
        }
        if (operationType === "write" && !user.isInRole("codbex-opportunities.Quotation.QuotationFullAccess")) {
            throw new ForbiddenError();
        }
    }
