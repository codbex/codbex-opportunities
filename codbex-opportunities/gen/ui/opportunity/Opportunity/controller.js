angular.module('page', ["ideUI", "ideView", "entityApi"])
	...
	.controller('PageController', ['$scope', '$http', 'messageHub', 'entityApi', function ($scope, $http, messageHub, entityApi) {
		...
		$http.get("/services/js/codbex-opportunities/gen/api/entities/OpportunityType.js").then(function (response) {
		...
		$http.get("/services/js/codbex-opportunities/gen/api/entities/OpportunityPriority.js").then(function (response) {
		...
		$http.get("/services/js/codbex-opportunities/gen/api/entities/OpportunityProbability.js").then(function (response) {
